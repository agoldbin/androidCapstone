...
public class AGoldbinDB extends SQLiteOpenHelper {
    ...
    public AGoldbinDB(Context context, String name,
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_PRODUCTS_TABLE = "CREATE TABLE " +
                TABLE_WORKOUTS + "("
                + COLUMN_ID + " INTEGER PRIMARY KEY," + COLUMN_WORKOUTNAME
     ...
     *
     * @param workout  an instance of our Product data model class
     */
    public void addProduct(Workout workout) {

        ContentValues values = new ContentValues();
        //content object primed with key-value pairs for the data columns extracted from the Product object
        values.put(COLUMN_WORKOUTNAME, workout.getMWorkoutName());
        values.put(COLUMN_DATE, workout.getMWorkoutDate().toString());
    ...
    public Product findProduct(String productname) {
        String query = "Select * FROM " + TABLE_WORKOUTS + " WHERE " + COLUMN_WORKOUTNAME + " =  \"" + productname + "\"";
